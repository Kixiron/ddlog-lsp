    ...
    Ctx: crate::node::Context<'tree> + 'tree,
{
    ...
    fn visit(&mut self) -> Result<(), SyntaxErrors> {
        ...
        match node.kind_id() {
            ...
            kind::CLEAR => self.visit_clear(NodeMove::Init),
            kind::COMMAND => self.visit_command(NodeMove::Init),
            kind::COMMENT_LINE => self.visit_comment_line(NodeMove::Init),
            kind::COMMIT => self.visit_commit(NodeMove::Init),
            kind::CONS => self.visit_cons(NodeMove::Init),
            kind::CONS_ARG => self.visit_cons_arg(NodeMove::Init),
            kind::CONS_ARGS => self.visit_cons_args(NodeMove::Init),
            kind::CONS_POS => self.visit_cons_pos(NodeMove::Init),
            kind::CONS_REC => self.visit_cons_rec(NodeMove::Init),
            kind::DELETE => self.visit_delete(NodeMove::Init),
            kind::DELETE_KEY => self.visit_delete_key(NodeMove::Init),
            kind::DUMP => self.visit_dump(NodeMove::Init),
            kind::DUMP_INDEX => self.visit_dump_index(NodeMove::Init),
            kind::ECHO => self.visit_echo(NodeMove::Init),
            kind::EXIT => self.visit_exit(NodeMove::Init),
            ...
            kind::INSERT => self.visit_insert(NodeMove::Init),
            kind::INSERT_OR_UPDATE => self.visit_insert_or_update(NodeMove::Init),
            ...
            kind::LIT_SERIALIZED => self.visit_lit_serialized(NodeMove::Init),
            kind::LIT_STRING => self.visit_lit_string(NodeMove::Init),
            kind::LIT_VEC => self.visit_lit_vec(NodeMove::Init),
            kind::LOG_LEVEL => self.visit_log_level(NodeMove::Init),
            kind::MISC_PAT0 => self.visit_misc_pat0(NodeMove::Init),
            kind::MODIFY => self.visit_modify(NodeMove::Init),
            ...
            kind::PROFILE => self.visit_profile(NodeMove::Init),
            kind::QUERY_INDEX => self.visit_query_index(NodeMove::Init),
            kind::RECORD => self.visit_record(NodeMove::Init),
            kind::RECORD_NAMED => self.visit_record_named(NodeMove::Init),
            kind::ROLLBACK => self.visit_rollback(NodeMove::Init),
            kind::SERDE_ENCODING => self.visit_serde_encoding(NodeMove::Init),
            kind::SLEEP => self.visit_sleep(NodeMove::Init),
            kind::START => self.visit_start(NodeMove::Init),
            kind::TIMESTAMP => self.visit_timestamp(NodeMove::Init),
            ...
            kind::UPDATE => self.visit_update(NodeMove::Init),
            kind::UPDATES => self.visit_updates(NodeMove::Init),
            kind::UPDATES_END => self.visit_updates_end(NodeMove::Init),
            kind::VAL_ARRAY => self.visit_val_array(NodeMove::Init),
            kind::VAL_STRUCT => self.visit_val_struct(NodeMove::Init),
            kind::VAL_TUPLE => self.visit_val_tuple(NodeMove::Init),
