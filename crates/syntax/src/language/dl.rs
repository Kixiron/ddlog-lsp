    ...
    Ctx: crate::node::Context<'tree> + 'tree,
{
    ...
    fn visit(&mut self) -> Result<(), SyntaxErrors> {
        let node = self.node();
        match node.kind_id() {
            kind::ROOT => self.visit_ROOT(NodeMove::Init),
            kind::ANNOTATED_ITEM => self.visit_annotated_item(NodeMove::Init),
            kind::APPLY => self.visit_apply(NodeMove::Init),
            kind::ARG => self.visit_arg(NodeMove::Init),
            kind::ARG_OPT_TYPE => self.visit_arg_opt_type(NodeMove::Init),
            kind::ARG_TRANS => self.visit_arg_trans(NodeMove::Init),
            kind::ATOM => self.visit_atom(NodeMove::Init),
            kind::ATOM_ELEM => self.visit_atom_elem(NodeMove::Init),
            kind::ATOM_POS => self.visit_atom_pos(NodeMove::Init),
            kind::ATOM_REC => self.visit_atom_rec(NodeMove::Init),
            kind::ATTRIBUTE => self.visit_attribute(NodeMove::Init),
            kind::ATTRIBUTES => self.visit_attributes(NodeMove::Init),
            kind::COMMENT_BLOCK => self.visit_comment_block(NodeMove::Init),
            kind::COMMENT_BLOCK_INNER => self.visit_comment_block_inner(NodeMove::Init),
            kind::COMMENT_LINE => self.visit_comment_line(NodeMove::Init),
            kind::CONS => self.visit_cons(NodeMove::Init),
            kind::CONS_POS => self.visit_cons_pos(NodeMove::Init),
            kind::CONS_REC => self.visit_cons_rec(NodeMove::Init),
            kind::ESCAPE_SEQUENCE => self.visit_escape_sequence(NodeMove::Init),
            kind::ESCAPE_SEQUENCE_INTERPOLATED => self.visit_escape_sequence_interpolated(NodeMove::Init),
            kind::EXP => self.visit_exp(NodeMove::Init),
            kind::EXP_ADD => self.visit_exp_add(NodeMove::Init),
            kind::EXP_ASSIGN => self.visit_exp_assign(NodeMove::Init),
            kind::EXP_BINDING => self.visit_exp_binding(NodeMove::Init),
            kind::EXP_BIT_AND => self.visit_exp_bit_and(NodeMove::Init),
            kind::EXP_BIT_NEG => self.visit_exp_bit_neg(NodeMove::Init),
            kind::EXP_BIT_OR => self.visit_exp_bit_or(NodeMove::Init),
            kind::EXP_BIT_SLICE => self.visit_exp_bit_slice(NodeMove::Init),
            kind::EXP_BIT_XOR => self.visit_exp_bit_xor(NodeMove::Init),
            kind::EXP_BLOCK => self.visit_exp_block(NodeMove::Init),
            kind::EXP_BREAK => self.visit_exp_break(NodeMove::Init),
            kind::EXP_CAST => self.visit_exp_cast(NodeMove::Init),
            kind::EXP_CAT => self.visit_exp_cat(NodeMove::Init),
            kind::EXP_COND => self.visit_exp_cond(NodeMove::Init),
            kind::EXP_CONS_POS => self.visit_exp_cons_pos(NodeMove::Init),
            kind::EXP_CONS_REC => self.visit_exp_cons_rec(NodeMove::Init),
            kind::EXP_CONTINUE => self.visit_exp_continue(NodeMove::Init),
            kind::EXP_DECL_VAR => self.visit_exp_decl_var(NodeMove::Init),
            kind::EXP_DIV => self.visit_exp_div(NodeMove::Init),
            kind::EXP_EQ => self.visit_exp_eq(NodeMove::Init),
            kind::EXP_FIELD => self.visit_exp_field(NodeMove::Init),
            kind::EXP_FOR => self.visit_exp_for(NodeMove::Init),
            kind::EXP_FUN_CALL => self.visit_exp_fun_call(NodeMove::Init),
            kind::EXP_FUN_CALL_DOT => self.visit_exp_fun_call_dot(NodeMove::Init),
            kind::EXP_GT => self.visit_exp_gt(NodeMove::Init),
            kind::EXP_GTEQ => self.visit_exp_gteq(NodeMove::Init),
            kind::EXP_LAMBDA => self.visit_exp_lambda(NodeMove::Init),
            kind::EXP_LIT => self.visit_exp_lit(NodeMove::Init),
            kind::EXP_LOG_AND => self.visit_exp_log_and(NodeMove::Init),
            kind::EXP_LOG_IMP => self.visit_exp_log_imp(NodeMove::Init),
            kind::EXP_LOG_NEG => self.visit_exp_log_neg(NodeMove::Init),
            kind::EXP_LOG_OR => self.visit_exp_log_or(NodeMove::Init),
            kind::EXP_LT => self.visit_exp_lt(NodeMove::Init),
            kind::EXP_LTEQ => self.visit_exp_lteq(NodeMove::Init),
            kind::EXP_MATCH => self.visit_exp_match(NodeMove::Init),
            kind::EXP_MUL => self.visit_exp_mul(NodeMove::Init),
            kind::EXP_NEG => self.visit_exp_neg(NodeMove::Init),
            kind::EXP_NEQ => self.visit_exp_neq(NodeMove::Init),
            kind::EXP_PROJ => self.visit_exp_proj(NodeMove::Init),
            kind::EXP_PROJ_DIGITS => self.visit_exp_proj_digits(NodeMove::Init),
            kind::EXP_REF => self.visit_exp_ref(NodeMove::Init),
            kind::EXP_REM => self.visit_exp_rem(NodeMove::Init),
            kind::EXP_RETURN => self.visit_exp_return(NodeMove::Init),
            kind::EXP_SEQ => self.visit_exp_seq(NodeMove::Init),
            kind::EXP_SHL => self.visit_exp_shl(NodeMove::Init),
            kind::EXP_SHR => self.visit_exp_shr(NodeMove::Init),
            kind::EXP_SLICE => self.visit_exp_slice(NodeMove::Init),
            kind::EXP_SUB => self.visit_exp_sub(NodeMove::Init),
            kind::EXP_TRY => self.visit_exp_try(NodeMove::Init),
            kind::EXP_TUPLE => self.visit_exp_tuple(NodeMove::Init),
            kind::EXP_TYPE => self.visit_exp_type(NodeMove::Init),
            kind::EXP_WILD => self.visit_exp_wild(NodeMove::Init),
            kind::FIELD => self.visit_field(NodeMove::Init),
            kind::FUNCTION => self.visit_function(NodeMove::Init),
            kind::FUNCTION_EXTERN => self.visit_function_extern(NodeMove::Init),
            kind::FUNCTION_NORMAL => self.visit_function_normal(NodeMove::Init),
            kind::IDENT => self.visit_ident(NodeMove::Init),
            kind::IDENT_LOWER => self.visit_ident_lower(NodeMove::Init),
            kind::IDENT_LOWER_SCOPED => self.visit_ident_lower_scoped(NodeMove::Init),
            kind::IDENT_SCOPED => self.visit_ident_scoped(NodeMove::Init),
            kind::IDENT_UPPER => self.visit_ident_upper(NodeMove::Init),
            kind::IDENT_UPPER_SCOPED => self.visit_ident_upper_scoped(NodeMove::Init),
            kind::IMPORT => self.visit_import(NodeMove::Init),
            kind::INDEX => self.visit_index(NodeMove::Init),
            kind::INTERPOLATION => self.visit_interpolation(NodeMove::Init),
            kind::ITEM => self.visit_item(NodeMove::Init),
            kind::KEY_PRIMARY => self.visit_key_primary(NodeMove::Init),
            kind::LIT_BOOL => self.visit_lit_bool(NodeMove::Init),
            kind::LIT_MAP => self.visit_lit_map(NodeMove::Init),
            kind::LIT_NUM => self.visit_lit_num(NodeMove::Init),
            kind::LIT_NUM_BIN => self.visit_lit_num_bin(NodeMove::Init),
            kind::LIT_NUM_DEC => self.visit_lit_num_dec(NodeMove::Init),
            kind::LIT_NUM_FLOAT => self.visit_lit_num_float(NodeMove::Init),
            kind::LIT_NUM_HEX => self.visit_lit_num_hex(NodeMove::Init),
            kind::LIT_NUM_OCT => self.visit_lit_num_oct(NodeMove::Init),
            kind::LIT_STRING => self.visit_lit_string(NodeMove::Init),
            kind::LIT_VEC => self.visit_lit_vec(NodeMove::Init),
            kind::MISC_PAT0 => self.visit_misc_pat0(NodeMove::Init),
            kind::MODULE_ALIAS => self.visit_module_alias(NodeMove::Init),
            kind::MODULE_PATH => self.visit_module_path(NodeMove::Init),
            kind::NAME => self.visit_name(NodeMove::Init),
            kind::NAME_ARG => self.visit_name_arg(NodeMove::Init),
            kind::NAME_CONS => self.visit_name_cons(NodeMove::Init),
            kind::NAME_FIELD => self.visit_name_field(NodeMove::Init),
            kind::NAME_FUNC => self.visit_name_func(NodeMove::Init),
            kind::NAME_INDEX => self.visit_name_index(NodeMove::Init),
            kind::NAME_REL => self.visit_name_rel(NodeMove::Init),
            kind::NAME_TRANS => self.visit_name_trans(NodeMove::Init),
            kind::NAME_TYPE => self.visit_name_type(NodeMove::Init),
            kind::NAME_VAR_TERM => self.visit_name_var_term(NodeMove::Init),
            kind::NAME_VAR_TYPE => self.visit_name_var_type(NodeMove::Init),
            kind::PAT => self.visit_pat(NodeMove::Init),
            kind::PAT_CONS => self.visit_pat_cons(NodeMove::Init),
            kind::PAT_CONS_POS => self.visit_pat_cons_pos(NodeMove::Init),
            kind::PAT_CONS_REC => self.visit_pat_cons_rec(NodeMove::Init),
            kind::PAT_LIT => self.visit_pat_lit(NodeMove::Init),
            kind::PAT_TERM_DECL_VAR => self.visit_pat_term_decl_var(NodeMove::Init),
            kind::PAT_TUPLE => self.visit_pat_tuple(NodeMove::Init),
            kind::PAT_TYPE => self.visit_pat_type(NodeMove::Init),
            kind::PAT_WILD => self.visit_pat_wild(NodeMove::Init),
            kind::REL => self.visit_rel(NodeMove::Init),
            kind::REL_ARGS => self.visit_rel_args(NodeMove::Init),
            kind::REL_ELEM => self.visit_rel_elem(NodeMove::Init),
            kind::REL_ROLE => self.visit_rel_role(NodeMove::Init),
            kind::REL_SEMANTICS => self.visit_rel_semantics(NodeMove::Init),
            kind::RHS => self.visit_rhs(NodeMove::Init),
            kind::RHS_ATOM_NEG => self.visit_rhs_atom_neg(NodeMove::Init),
            kind::RHS_FLAT_MAP => self.visit_rhs_flat_map(NodeMove::Init),
            kind::RHS_GROUPING => self.visit_rhs_grouping(NodeMove::Init),
            kind::RHS_INSPECT => self.visit_rhs_inspect(NodeMove::Init),
            kind::RULE => self.visit_rule(NodeMove::Init),
            kind::RULE_END => self.visit_rule_end(NodeMove::Init),
            kind::STATEMENT => self.visit_statement(NodeMove::Init),
            kind::STATEMENT_ASSIGN => self.visit_statement_assign(NodeMove::Init),
            kind::STATEMENT_BLOCK => self.visit_statement_block(NodeMove::Init),
            kind::STATEMENT_EMPTY => self.visit_statement_empty(NodeMove::Init),
            kind::STATEMENT_FOR => self.visit_statement_for(NodeMove::Init),
            kind::STATEMENT_IF => self.visit_statement_if(NodeMove::Init),
            kind::STATEMENT_INSERT => self.visit_statement_insert(NodeMove::Init),
            kind::STATEMENT_MATCH => self.visit_statement_match(NodeMove::Init),
            kind::STRING_QUOTED => self.visit_string_quoted(NodeMove::Init),
            kind::STRING_QUOTED_ESCAPED => self.visit_string_quoted_escaped(NodeMove::Init),
            kind::STRING_RAW => self.visit_string_raw(NodeMove::Init),
            kind::STRING_RAW_INTERPOLATED => self.visit_string_raw_interpolated(NodeMove::Init),
            kind::TRANSFORMER => self.visit_transformer(NodeMove::Init),
            kind::TYPE => self.visit_type(NodeMove::Init),
            kind::TYPE_ATOM => self.visit_type_atom(NodeMove::Init),
            kind::TYPE_BIGINT => self.visit_type_bigint(NodeMove::Init),
            kind::TYPE_BIT => self.visit_type_bit(NodeMove::Init),
            kind::TYPE_BOOL => self.visit_type_bool(NodeMove::Init),
            kind::TYPE_DOUBLE => self.visit_type_double(NodeMove::Init),
            kind::TYPE_FLOAT => self.visit_type_float(NodeMove::Init),
            kind::TYPE_FUN => self.visit_type_fun(NodeMove::Init),
            kind::TYPE_SIGNED => self.visit_type_signed(NodeMove::Init),
            kind::TYPE_STRING => self.visit_type_string(NodeMove::Init),
            kind::TYPE_TRANS => self.visit_type_trans(NodeMove::Init),
            kind::TYPE_TRANS_FUN => self.visit_type_trans_fun(NodeMove::Init),
            kind::TYPE_TRANS_REL => self.visit_type_trans_rel(NodeMove::Init),
            kind::TYPE_TUPLE => self.visit_type_tuple(NodeMove::Init),
            kind::TYPE_UNION => self.visit_type_union(NodeMove::Init),
            kind::TYPE_USER => self.visit_type_user(NodeMove::Init),
            kind::TYPE_VAR => self.visit_type_var(NodeMove::Init),
            kind::TYPEDEF => self.visit_typedef(NodeMove::Init),
            kind::TYPEDEF_EXTERN => self.visit_typedef_extern(NodeMove::Init),
            kind::TYPEDEF_NORMAL => self.visit_typedef_normal(NodeMove::Init),
